...
exports.imageGenController = exports.anotherGeminiController = exports.geminiController = void 0;
...
const anotherGeminiController = async (req, res) => {
    const { symptoms, age, gender } = req.body;
    console.log('Received request body:', req.body);
    // Validate request body
    if (!req.body || !symptoms || !age || !gender) {
...
exports.anotherGeminiController = anotherGeminiController;
const imageGenController = async (req, res) => {
